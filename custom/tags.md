...
---------------------------------------------------------
/=/=/=/ Regular [[Блок 2. React + TS]]Title 4
---------------------------------------------------------
...
1) Инициализируем проект
    $ npm init      /=/ подробное создание package.json
    $ npm init -y  /=/ быстрое создание package.json
...
И в module.exports = {
    ...
    plugins: [
        new HtmlWebpackPlugin({
            template: 'путь_к_вашему_index.html',
        }),
    ],
}
...
function App() {
    ...
    path=_____________________"/catalog/:category?/:subCategory?"
